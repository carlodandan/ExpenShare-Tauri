...
export default function SummaryCard({ label, minor, tone = 'neutral', sublabel }) {
  ...
  return (
    <div className="rounded-lg border border-line bg-surface px-3.5 py-3 sm:px-5 sm:py-4">
      <p className="font-mono text-[10px] uppercase tracking-[0.14em] text-ink-muted sm:text-[11px]">{label}</p>
