...
export default function SummaryCard({ label, minor, tone = 'neutral', sublabel }) {
  ...
  return (
    <div className="rounded-lg border border-line bg-paper/80 px-3.5 py-3 sm:px-5 sm:py-4">
      <p className="font-sunflower text-xs uppercase tracking-[0.12em] text-ink-muted">{label}</p>
      <p className={`tabular mt-1 text-xl font-regular sm:text-2xl ${TONE_CLASSES[resolvedTone]}`}>
